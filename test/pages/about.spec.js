...
describe('About Page', () => {
  test('should render about page content', async () => {
  ...
  test('should contain key information about Jose', async () => {
    const wrapper = await mountSuspended(About);
  ...
  test('should contain technology information', async () => {
    const wrapper = await mountSuspended(About);
  ...
  test('should contain site technology stack information', async () => {
    const wrapper = await mountSuspended(About);
  ...
  test('should have external link to pnpm', async () => {
    const wrapper = await mountSuspended(About);
  ...
  test('should have proper prose styling classes', async () => {
    const wrapper = await mountSuspended(About);
